    ...
    <main>
        <section class="sample-text-area">
            <div class="container box_1170">
                <h3 class="text-heading">Update available aircrafts</h3>
            </div>
        </section>
        <!-- End Sample Area -->
        <div id="msg"></div>
        <div class="container" >
            <div class="table-responsive mt-2" id="table-container">
                <table class="table table-bordered table-striped text-center" id="user_data">
                    <tbody>
                        <thead>
                            <tr>
                                <th>ID</th>
                ...
                <?php
                    ...
                    // fetch query
                    $query = ("SELECT AIRCRAFT.MODEL_ID, AIRCRAFT.AIRCRAFT_ID, AIRCRAFT.AIRCRAFT_CODE, AIRCRAFT.AIRCRAFT_IMAGE, AIRCRAFT.AIRCRAFT_NAME, AIRCRAFT.PRICE 
                    FROM `AIRCRAFT`
                    ...
                    echo "<tr>
                            ...
                            <td>".$row['AIRCRAFT_IMAGE']."</td>
                            <td>".$row['AIRCRAFT_NAME']."</td>
                            <td>".$row['PRICE']."</td>
                            <td><a style=color:blue; href='update-form.php?id=".$row["AIRCRAFT_ID"]."&code=".$row["AIRCRAFT_CODE"]."&image=".$row["AIRCRAFT_IMAGE"]."&name=".$row["AIRCRAFT_NAME"]."&price=".$row["PRICE"]." '>Edit</a></td> </tr>";
