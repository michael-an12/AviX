                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li><i class="fas fa-phone"></i> <?php  echo $user_email_id; ?>+233 26 192 7932</li>
    ...
    <main>
        <section class="sample-text-area">
            <div class="container box_1170">
                <h3 class="text-heading">My Cart</h3>
            </div>
        </section>
        <!-- End Sample Area -->
        <div class="container">
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            ...
                            <form action="">
                                ...
                                <button type="button" class="cart" style="display: none;"></button>
                            </form>
                        ...
                        <?php
                            ...
                            $stmt = $con->prepare("SELECT AIRCRAFT.MODEL_ID, AIRCRAFT.AIRCRAFT_ID, AIRCRAFT.AIRCRAFT_CODE, AIRCRAFT.AIRCRAFT_IMAGE, AIRCRAFT.AIRCRAFT_NAME, AIRCRAFT.PRICE ,user_collections.TOTAL_PRICE, user_collections.QUANTITY
                            FROM `AIRCRAFT` 
                            INNER JOIN user_collections ON user_collections.AIRCRAFT_ID = AIRCRAFT.AIRCRAFT_ID 
                            WHERE user_collections.user_email_id = '$user_email_id'");
                            $stmt->execute();
                        ...
                        <tr>
                            ...
                            <td><img src="<?= $row['AIRCRAFT_IMAGE'] ?>" width="50"></td>
                            ...
                            <td>
                            <a href="action.php?remove=<?= $row['AIRCRAFT_ID'] ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3">
                            <a href="../services.php" class="btn btn-success">Continue Shopping</a>
                            </td>
